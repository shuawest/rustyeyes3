# Project Requirements Specification: RustyEyes3
...
### 2.2. Computer Vision Pipelines
The system shall support runtime-switchable pipelines:

#### 2.2.1. Face Detection (Key 2)
...
#### 2.2.3. Head Pose estimation (Key 3)
*   **Model**: WHENet (ONNX).
...
#### 2.2.5. Pupil Gaze (Key 5)
*   **Type**: Computer Vision / Hybrid.
*   **Function**: Track pupil position *within* the eye using pixel-intensity blob tracking (finding the darkest region) combined with Head Pose.
